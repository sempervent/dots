...
| `setup.sh` | Install / refresh (packages, links, optional components) |
...
- [Profiles](profiles.md) · [Packages](packages.md) · [Components](components.md)
- [Extending](../using/extending.md) · [Skills](../using/skills.md)
- [Generated registries](../reference/generated/components.md)
